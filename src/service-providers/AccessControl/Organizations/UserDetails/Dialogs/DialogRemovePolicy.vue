...
const emit = defineEmits(["closeDialog", "policiesUpdated"]);
...
const subtitleText = computed(() => {
  return `Are you sure you want to remove this policy assigned to ${props.user.user.first_name} ${props.user.user.last_name} from ${props.organizationName}?`;
});
