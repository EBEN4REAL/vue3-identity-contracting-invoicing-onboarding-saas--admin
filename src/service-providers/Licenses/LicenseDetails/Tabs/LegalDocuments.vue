...
import { LegalDocumentRead } from "~/service-providers/LegalDocuments/legal-documents.types";

const props = defineProps({
  documents: {
    type: Object as PropType<TableResponse<LegalDocumentRead> | null>,
    required: true,
    default: () => {},
  },
  isLoading: {
...
const documentName = (row: LegalDocumentRead) => row.name || "-";
