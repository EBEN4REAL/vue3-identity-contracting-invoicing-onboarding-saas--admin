Feature: Configuration - Applications
  ...
  Scenario Outline: Success from direct URL
    ...
    And the Configuration GET OAuth Clients request has been intercepted to return the OAuth Clients "002,001" for Service Provider "001"
    When the User navigates to "/sp/configuration"
  ...
  Scenario: Success from App Navigation
    ...
    When the User clicks on the Element with selector "#app-navigation-configuration"
    And the intercepted requests have resolved
    Then the Element with Cypress ID "applications-table" should be visible
    And the Element with Cypress ID "row-0 name" should have the text as "Auth Client 001"
    ...
    And the intercepted requests have resolved
    And the Element with Cypress ID "row-0 name" should have the text as "Auth Client 002"
