Feature: Subscriptions - Payments
  ...
  Scenario: Forbidden with non-Org User
    ...
    When the User navigates to "/sp/payments"
  ...
  Scenario Outline: Success with from direct URL
    ...
    And the billing request has been intercepted to return the charges for Service Provider "4a6f01d0-f3c6-4923-ad98-112d6d97355b"
    When the User navigates to "/sp/payments"
    And the intercepted requests have resolved
    Then the Element with Cypress ID "payments-table" should be visible
  ...
  Scenario: Success with SP Admin from App Navigation
    ...
    And the User clicks on the Element with selector "#app-navigation-subscriptions-payments"
    And the intercepted requests have resolved
    Then the Element with Cypress ID "payments-table" should be visible
    And the Element with Cypress ID "payment-id-column-3fa85f64-5717-4562-b3fc-2c963f66afa6" should have the text as "3fa85f64-5717-4562-b3fc-2c963f66afa6"
