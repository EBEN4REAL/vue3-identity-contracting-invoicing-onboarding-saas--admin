Feature: Access Control - Policy Based
  ...
  Scenario: Success with correct info displayed in Policies tab
    ...
    When the User navigates to "/sp/access-control/policy-based"
    Then the Element with Cypress ID "tab-item-policies" should have a class "mm-tabs-item--active"
    Then the Element with Cypress ID "access-control-policies-table" should be visible
    Then the Element with Cypress ID "create-policy-button" should be visible
  ...
  Scenario: Success with correct info displayed in Assigned Policies tab
    ...
    When the User navigates to "/sp/access-control/policy-based"
    And the User clicks on the Element with Cypress ID "tab-item-assigned-policies"
    Then the Element with Cypress ID "tab-item-assigned-policies" should have a class "mm-tabs-item--active"
    ...
    When the User clicks on the Element with Cypress ID "sort-icon-name"
    And the Policies request has been intercepted to return the All Policies "002,001" for Service Provider "4a6f01d0-f3c6-4923-ad98-112d6d97355b" with query params "limit=10&offset=0&sort=name:desc&exclude_category_id=a7a82589-c6ae-481d-b87c-16a7009b0d8f"
